...
public class CircleOutlineTool extends Constants{
	public Main cls;
	...
	public CircleOutlineTool(Main cls,ImageEditorWindow i){
		this.cls=cls;
		this.i=i;
	}
	...
	public void draw(Graphics2D g,Rectangle r){
		...
		g.drawOval(r.x+(r.w-(int)(r.w*CIRCLE_TOOL_ICON_SIZE_PROC))/2,r.y+(r.h-(int)(r.h*CIRCLE_TOOL_ICON_SIZE_PROC))/2,(int)(r.w*CIRCLE_TOOL_ICON_SIZE_PROC),(int)(r.h*CIRCLE_TOOL_ICON_SIZE_PROC));
	...
	public void update(){
		if (this.cls.MOUSE==1&&this.cls.MOUSE_COUNT==1&&this.cls.MOUSE_BUTTON==1){
			...
			g.drawOval(this.s.x-r,this.s.y-r,r*2,r*2);
			g.dispose();
			this.s=null;
			this.r=null;
		}
